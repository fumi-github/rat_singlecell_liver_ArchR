...
## Detect mediator motifs by conditional analysis
...
# saveRDS(weightMatrix, file = paste0("weightMatrix.",  tgtct, ".rds"))
weightMatrix = readRDS(paste0("weightMatrix.",  tgtct, ".rds"))
```
...
# saveRDS(res, file = paste0("NMF.", tgtct, ".rds"))
res = readRDS(paste0("NMF.", tgtct, ".rds"))
