...
resultcompared %>%
  ...
  tidyr::pivot_wider(names_from = sample, values_from = c("foldchange", "statistic", "p", "rank")) %>%
...
ggplot(data = dataplot,
       aes(x = statistic,
           y = bulkZ)) +
  geom_point(size = 0.5) +
  # geom_point(size = 0.5, aes(col = log10(width))) +
  # scale_color_gradientn(colors = c("black", "khaki3", "red")) +
  stat_smooth() +
