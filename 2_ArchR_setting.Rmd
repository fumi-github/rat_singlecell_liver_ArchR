...
Jump to the appropriate section, according to the reference genome,
rn6 or rn7.
...
```{r}
library(BSgenome)
forgeBSgenomeDataPkg("/home/fumi/human/publicrat/rn7/BSgenome.Rnorvegicus.UCSC.rn7-seed")
```
